...
/*   Updated: 2021/04/02 15:45:36 by aabelque         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			nm_elf(char *ptr, char *offset, char *bin)
{
	...
	if ((unsigned char)ptr[ELFMAG0] == 0x7f &&
			(unsigned char)ptr[ELFMAG1] == 'E' &&
			(unsigned char)ptr[ELFMAG2] == 'L' &&
			(unsigned char)ptr[ELFMAG3] == 'F')
	{
